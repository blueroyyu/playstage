...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_app_badger/flutter_app_badger.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/iamport_flutter/iamport_flutter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/iamport_webview_flutter/iamport_webview_flutter.framework"
